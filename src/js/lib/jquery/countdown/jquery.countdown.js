...
( function($) {
		...
		function hoursMinutesSeconds($this, opts) {
			...
			var _data = {
				hours : window['hours_HMS' + id],
				minutes : window['minutes_HMS' + id],
				seconds : window['seconds_HMS' + id]
			};
			if (opts.timeTick != null && opts.timeTick != undefined) {
				opts.timeTick.call($this, _data);
			}
			id = null;
		}
